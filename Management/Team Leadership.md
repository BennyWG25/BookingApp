...
Team Member and Roles:
	...
	Jacob Lief, JL4407 - Quality assurance, scrutinising decisions and codebase.
### Skills Matrix
...
flowchart TD
    CEO["Ben Gray - CEO"]
    CEO --> CTO["Andrew Jones - CTO"]
    CEO --> CPO["Zaid Sajjid - CPO"]
    CEO <--> QA["Jacob Lief - Quality Asurance"]
    
    CTO --> p1["Ben Gray as programmer"]
    CTO --> p2["Zaid Sajjid as frontend designer"]
    
    
    style CEO fill:#4A90D9,color:#fff,stroke:#2C6FAC
    style CTO fill:#7B68EE,color:#fff,stroke:#5A4FBF
    style CPO fill:#7B68EE,color:#fff,stroke:#5A4FBF
    style QA fill:#7B68EE,color:#fff,stroke:#5A4FBF
